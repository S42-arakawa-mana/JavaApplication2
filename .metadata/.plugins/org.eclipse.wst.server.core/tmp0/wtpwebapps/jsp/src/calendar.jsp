...
<%
  ...
  String year = (String)request.②("year");
  String month = (String)request.②("month");
  ...
  ⑥.setAttribute("dates", dates);  
  ⑥.setAttribute("date", Date.from(localDate.atStartOfDay(ZoneId.systemDefault()).toInstant()));
...
<body>
  <form method="⑦" action="/jsp/calendar.jsp">
    <ul>
